...
*/
cl_device_id OpenCLpreparation::create_device() {
...
cl_program OpenCLpreparation::build_program(cl_context ctx, cl_device_id dev, const char* filename) {

    std::cout << "File contain openCL code: " << filename << std::endl;
